...
public final class GlossaryReaderTBX {
    ...
    private static List<GlossaryEntry> readMartif(final InputStream is,
                                                  boolean priorityGlosary, String origin) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (next == XMLStreamConstants.START_ELEMENT) {
                if (reader.getLocalName().equals("note")) {
                    ...
                    while (reader.hasNext()) {
                        next = reader.next();
                        if ((next == XMLStreamConstants.END_ELEMENT) && ((reader.getLocalName().equals("langSet") || reader.getLocalName().equals("langSec")))) {
                            break;
                        }
    ...
    private static void appendProperty(StringBuilder str, final String prefix,
        ...
        if (reader.getLocalName().equals("descrip")) {
            if ("context".equals(reader.getAttributeValue(null, "type"))) {
                ...
                appendLine(str, prefix + reader.getAttributeValue(null, "type") + ": " + readContent(reader,
                        "descrip"));
            }
        }
