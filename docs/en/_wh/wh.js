...
["Principles","chapter.instant.start.guide.html#introduction.omegat.principles",[
["Translation\n      project","chapter.instant.start.guide.html#introduction.omegat.principles.translation.project",null],
["Translation\n      memories","chapter.instant.start.guide.html#introduction.omegat.principles.translation.memories",null],
["Collaboration","chapter.instant.start.guide.html#introduction.omegat.principles.collaboration",null],
["Made\n      for translators","chapter.instant.start.guide.html#introduction.omegat.principles.made.for.translators",null]
]],
...
["Troubleshoot issues","chapter.how.to.html#how.to.restore.your.data",[
["Automatic\n\tbackups","chapter.how.to.html#how.to.restore.your.data.automatic.backup",null],
["You lost your\n\ttranslation?","chapter.how.to.html#how.to.restore.your.data.lost.in.translation",null],
["Your project\n\twon’t open?","chapter.how.to.html#how.to.restore.your.data.project.wont.open",null],
["Your\n\ttranslated file won’t open?","chapter.how.to.html#how.to.restore.your.data.translated.file.broken",null],
["OmegaT won’t\n\tbehave?","chapter.how.to.html#how.to.restore.your.data.omegat.wont.behave",null],
["Summary","chapter.how.to.html#how.to.restore.your.data.summary",null]
]],
["Support other formats","chapter.how.to.html#how.to.translate.other.files",[
["Association","chapter.how.to.html#d0e1053",null],
["Conversion","chapter.how.to.html#d0e1064",null],
["Third-party\n\t\tplugins","chapter.how.to.html#how.to.translate.other.files.third.party.plugins",null],
["Development","chapter.how.to.html#d0e1176",null]
]],
["Use translation memories","chapter.how.to.html#how.to.use.tm",[
["Create your own TMs","chapter.how.to.html#how.to.use.tm.create.your.tm",null],
["Reuse TMs","chapter.how.to.html#how.to.use.tm.reuse.tm",null],
["Share TMs","chapter.how.to.html#how.to.tm.share.translation.memories",null],
["Bridge two languages","chapter.how.to.html#how.to.tm.bridge.two.languages",null]
]],
["Install\n  OmegaT","chapter.how.to.html#how.to.installing.omegat",[
["On Windows","chapter.how.to.html#installing.omegat.windows",null],
["On Linux","chapter.how.to.html#installing.omegat.linux.intel",null],
["On macOS","chapter.how.to.html#Installing.omegat.macos",null],
["On other platforms","chapter.how.to.html#installing.omegat.other.systems",null],
["Upgrade","chapter.how.to.html#update.and.delete.omegat",null],
["Delete OmegaT","chapter.how.to.html#update.and.delete.omegat.delete",null],
["Build OmegaT","chapter.how.to.html#build.omegat.from.source",null]
]],
["Run OmegaT","chapter.how.to.html#how.to.running.omegat",[
["On Windows","chapter.how.to.html#running.omegat.on.windows",null],
["On Linux","chapter.how.to.html#running.omegat.on.linux",null],
["On macOS","chapter.how.to.html#running.omegat.on.macos",null],
["On other platforms","chapter.how.to.html#running.omegat.on.other.systems",null],
["Command line launch","chapter.how.to.html#launch.with.command.line",null]
]],
["Set up a team project","chapter.how.to.html#how.to.setup.team.project",[
["Preparations","chapter.how.to.html#how.to.setup.team.project.prepare.the.repository",null],
["Repository\n\tmappings","chapter.how.to.html#how.to.setup.team.project.mapping.parameters",null],
["Example\n\tmappings","chapter.how.to.html#how.to.setup.team.project.example.mappings",null],
["Selective\n\tsharing","chapter.how.to.html#how.to.setup.team.project.selective.sharing",null]
]],
...
["\n                              Project\n  Properties\n                           ","chapter.windows.and.dialogs.html#dialogs.project.properties",[
["\n                                    Languages\n                                 ","chapter.windows.and.dialogs.html#dialogs.project.properties.languages",null],
["\n                                    Options\n                                 ","chapter.windows.and.dialogs.html#dialogs.project.properties.options",null],
["\n                                    File\n    locations\n                                 ","chapter.windows.and.dialogs.html#dialogs.project.properties.file.locations",null]
]],
["\n                              Source\n  Files\n                           ","chapter.windows.and.dialogs.html#windows.source.files.list",null],
["\n                              Text Search\n                           ","chapter.windows.and.dialogs.html#windows.text.search",[
["Search type","chapter.windows.and.dialogs.html#windows.text.search.methods",null],
["Options","chapter.windows.and.dialogs.html#windows.text.search.options",null],
["Results display","chapter.windows.and.dialogs.html#windows.text.search.result.display",null],
["Filter","chapter.windows.and.dialogs.html#windows.text.search.filter",null]
]],
["\n                              Text\n  Replace\n                           ","chapter.windows.and.dialogs.html#windows.text.replace",[
["Search type","chapter.windows.and.dialogs.html#windows.text.replace.methods",null],
["Options","chapter.windows.and.dialogs.html#windows.text.replace.options",null],
["Results display","chapter.windows.and.dialogs.html#windows.text.replace.result.display",null]
]],
["\n                              Align Files\n                           ","chapter.windows.and.dialogs.html#windows.aligner",[
["Settings","chapter.windows.and.dialogs.html#windows.aligner.adjust",null],
["Corrections","chapter.windows.and.dialogs.html#windows.aligner.manual.corrections",null]
]],
["\n                              Scripting\n                           ","chapter.windows.and.dialogs.html#windows.scripts",[
["The script folder","chapter.windows.and.dialogs.html#windows.scripts.folder",null],
["Usage","chapter.windows.and.dialogs.html#windows.scripts.usage",null],
["Distributed scripts","chapter.windows.and.dialogs.html#windows.scripts.distribution",null],
["Languages","chapter.windows.and.dialogs.html#windows.scripts.languages",null]
]]
]],
["Project Folder","chapter.project.folder.html",[
["Default structure","chapter.project.folder.html#d0e8389",null],
["Minimal contents","chapter.project.folder.html#d0e8467",null],
...
["\n                              Appearance\n                           ","chapter.dialogs.preferences.html#dialogs.preferences.appearance",[
["\n                                    Font\n                                 ","chapter.dialogs.preferences.html#dialogs.preferences.fonts",null],
["\n                                    Colors\n                                 ","chapter.dialogs.preferences.html#dialogs.preferences.colours",null]
]],
["\n                              Global File\n\tFilters\n                           ","chapter.dialogs.preferences.html#dialogs.preferences.file.filters",null],
["\n                              Global\n\tSegmentation Rules\n                           ","chapter.dialogs.preferences.html#dialogs.preferences.segmentation.setup",[
["Language\n\t  sets","chapter.dialogs.preferences.html#dialogs.preferences.segmentation.setup.scope",null],
["\n                                    Set contents\n                                 ","chapter.dialogs.preferences.html#segmentation.rules",null]
]],
...
["File Filters","chapter.appendices.html#file.filters",[
["Common preferences","chapter.appendices.html#file.filters.general",null],
["Edit","chapter.appendices.html#edit.filter.dialog",null],
["Options","chapter.appendices.html#filters.options",null]
]],
["Segmentation","chapter.appendices.html#app.segmentation",[
["Paragraph or\n\tsentence?","chapter.appendices.html#dialog.preferences.segmentation.setup.type",null],
["Global or\n\tlocal?","chapter.appendices.html#dialog.preferences.segmentation.setup.scope",null],
["Rules","chapter.appendices.html#dialog.preferences.segmentation.setup.rules.based.segmentation",null]
]],
["Regular expressions","chapter.appendices.html#app.regex",[
["The 4 rules","chapter.appendices.html#app.regex.four.rules",null],
["The 12 characters","chapter.appendices.html#app.regex.twelve.characters",null],
["Lots of\n    expressions","chapter.appendices.html#app.regex.types.of.expressions",null],
["More examples","chapter.appendices.html#app.regex.more.examples",null],
["References","chapter.appendices.html#app.regex.tools",null]
]],
["Glossaries","chapter.appendices.html#app.glossaries",[
["The glossaries folder","chapter.appendices.html#glossaries.glossary.folder",null],
["Project glossary","chapter.appendices.html#glossaries.default.glossary",null],
["File format","chapter.appendices.html#glossaries.fileformat",null]
]],
["Post-Processing Commands","chapter.appendices.html#post.processing.commands",[
["Template Variables","chapter.appendices.html#post.processing.commands.template.variables",null],
["User Defined\n    Scripts","chapter.appendices.html#post.processing.commands.user.defined.scripts",null],
["Linux and\n    macOS","chapter.appendices.html#post.processing.commands.linux.and.macos",null]
]],
["OmegaT Shortcuts","chapter.appendices.html#app.shortcuts",[
["Description","chapter.appendices.html#app.shortcuts.description",null],
["Customization","chapter.appendices.html#app.shortcuts.customization",null],
["Syntax","chapter.appendices.html#app.shortcuts.syntax",null],
["Lists of functions and codes","chapter.appendices.html#app.shortcuts.lists",null]
]],
["Configuration Folder","chapter.appendices.html#configuration.folder",[
["Location","chapter.appendices.html#configuration.folder.location",null],
["Default  contents","chapter.appendices.html#configuration.folder.default.contents",null],
["Additional contents","chapter.appendices.html#configuration.folder.extra.contents",null]
]],
...
var storageId = "-1pati2qf53zbv-1fyzmn5qisq1b";
